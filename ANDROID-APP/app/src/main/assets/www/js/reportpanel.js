...
componentDidMount: function() {
       ...
       $(".c-report-panel-list button").click(function(e){
        ...
        React.render(
          React.createElement(ReportDetail, {data: data}),
   ...
   */
   render: function() {
    ...
    return (
      React.createElement("div", {id: "report-panel", className: "c-report-panel-list c-report-floating-panel", style: startStyle}, 
      reports
      )
      );
  }
